...
public class BDSPhone implements Comparable<BDSPhone>, BDSContactDetails {

	private Integer priority;

	private String type;
	private Map<BDSLanguage, String> label = new HashMap<BDSLanguage, String>();
	private String value;

	private List<String> headingRestriction = new ArrayList<String>();

	public BDSPhone(Integer priority, String type, Map<BDSLanguage, String> label, String value) {
		super();
	...
	@Override
	public int compareTo(BDSPhone other) {
		if (priority != null) {
